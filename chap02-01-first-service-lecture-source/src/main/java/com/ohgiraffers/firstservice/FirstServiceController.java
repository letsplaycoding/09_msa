...
public class FirstServiceController {
    ...
    public String healthCheck() {
        ...
        /* 설명. first-service application(포트) 여러개 실행 시(스케일 아웃) 실행되는 application 확인(포트 번호로) */
        /* 설명. Gateway의 lb(로드 밸런싱)를 통해 RoundRobin 방식으로 스위칭됨을 확인 */
        return "난 괜차나.." + env.getProperty("local.server.port");
    }
