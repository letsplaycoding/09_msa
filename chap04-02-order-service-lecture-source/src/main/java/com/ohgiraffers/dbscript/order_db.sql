...
INSERT INTO TBL_ORDER_MENU VALUES (1, 2, 2);
INSERT INTO TBL_ORDER_MENU VALUES (1, 3, 1);
INSERT INTO TBL_ORDER_MENU VALUES (2, 4, 2);

COMMIT;CREATE TABLE IF NOT EXISTS tbl_order2
(
    order_code    INT AUTO_INCREMENT COMMENT '주문코드',
    user_id       VARCHAR(255) NOT NULL COMMENT '주문고객',
    order_date    VARCHAR(8) NOT NULL COMMENT '주문일자',
